...
#undef V
...
#endif
   {
      "pcsxtreme_amped_frameskip_type",
      "Xtreme FS TurboBoost",
      NULL,
   ...
   {
      "pcsxtreme_amped_frameskip_threshold",
      "Xtreme FSkip Threshold (%)",
      NULL,
   ...
   {
      "pcsxtreme_amped_frameskip_interval",
      "Xtreme FS Interval",
      NULL,
